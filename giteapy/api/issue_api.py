...
class IssueApi(object):
    ...
    def issue_edit_issue(self, owner, repo, index, **kwargs):  # noqa: E501
        ...
        Pass `content_version` to enable optimistic locking on body edits. If the version doesn't match the current value, the request fails with 409 Conflict.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def issue_list_issues(self, owner, repo, **kwargs):  # noqa: E501
        ...
        :param str labels: comma separated list of label names. Fetch only issues that have any of this label names. Non existent labels are discarded.
    ...
    def issue_search_issues_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['state', 'labels', 'milestones', 'q', 'type', 'since', 'before', 'assigned', 'created', 'mentioned', 'review_requested', 'reviewed', 'owner', 'created_by', 'team', 'page', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
