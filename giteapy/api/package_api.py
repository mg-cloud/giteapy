...
class PackageApi(object):
    ...
    def delete_package(self, owner, type, name, **kwargs):  # noqa: E501
        """Delete a package  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package(owner, type, name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_package_with_http_info(owner, type, name, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_package_with_http_info(owner, type, name, **kwargs)  # noqa: E501
            return data

    def delete_package_with_http_info(self, owner, type, name, **kwargs):  # noqa: E501
        """Delete a package  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package_with_http_info(owner, type, name, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/packages/{owner}/{type}/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_package_version(self, owner, type, name, version, **kwargs):  # noqa: E501
        """Delete a package version  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package_version(owner, type, name, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_package_version_with_http_info(owner, type, name, version, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_package_version_with_http_info(owner, type, name, version, **kwargs)  # noqa: E501
            return data

    def delete_package_version_with_http_info(self, owner, type, name, version, **kwargs):  # noqa: E501
        """Delete a package version  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_package_version_with_http_info(owner, type, name, version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_package_version" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `delete_package_version`")  # noqa: E501
        # verify the required parameter 'type' is set
        if self.api_client.client_side_validation and ('type' not in params or
                                                       params['type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `type` when calling `delete_package_version`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in params or
                                                       params['name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `name` when calling `delete_package_version`")  # noqa: E501
        # verify the required parameter 'version' is set
        if self.api_client.client_side_validation and ('version' not in params or
                                                       params['version'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `version` when calling `delete_package_version`")  # noqa: E501
