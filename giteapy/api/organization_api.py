...
class OrganizationApi(object):
    ...
    def get_org_runners_with_http_info(self, org, **kwargs):  # noqa: E501
        ...
        all_params = ['org', 'disabled']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_org_runner(self, org, runner_id, **kwargs):  # noqa: E501
        """Update an org-level runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_org_runner(org, runner_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_org_runner_with_http_info(org, runner_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_org_runner_with_http_info(org, runner_id, **kwargs)  # noqa: E501
            return data

    def update_org_runner_with_http_info(self, org, runner_id, **kwargs):  # noqa: E501
        """Update an org-level runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_org_runner_with_http_info(org, runner_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org', 'runner_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_org_runner" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org' is set
        if self.api_client.client_side_validation and ('org' not in params or
                                                       params['org'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org` when calling `update_org_runner`")  # noqa: E501
        # verify the required parameter 'runner_id' is set
        if self.api_client.client_side_validation and ('runner_id' not in params or
                                                       params['runner_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `runner_id` when calling `update_org_runner`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/orgs/{org}/actions/runners/{runner_id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
