...
class AdminApi(object):
    ...
    def admin_create_runner_registration_token(self, **kwargs):  # noqa: E501
        """Get a global actions runner registration token  # noqa: E501
    ...
    def admin_search_users(self, **kwargs):  # noqa: E501
        ...
        :param int page: page number of results to return (1-based)
        :param int limit: page size of results
        :param str sort: sort users by attribute. Supported values are \"name\", \"created\", \"updated\" and \"id\". Default is \"name\"
        :param str order: sort order, either \"asc\" (ascending) or \"desc\" (descending). Default is \"asc\", ignored if \"sort\" is not specified.
        :param str q: search term (username, full name, email)
        :param str visibility: visibility filter. Supported values are \"public\", \"limited\" and \"private\".
        :param bool is_active: filter active users
        :param bool is_admin: filter admin users
        :param bool is_restricted: filter restricted users
        :param bool is_2fa_enabled: filter 2FA enabled users
        :param bool is_prohibit_login: filter login prohibited users
        :return: list[User]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def admin_search_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['source_id', 'login_name', 'page', 'limit', 'sort', 'order', 'q', 'visibility', 'is_active', 'is_admin', 'is_restricted', 'is_2fa_enabled', 'is_prohibit_login']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'is_restricted' in params:
            query_params.append(('is_restricted', params['is_restricted']))  # noqa: E501
        if 'is_2fa_enabled' in params:
            query_params.append(('is_2fa_enabled', params['is_2fa_enabled']))  # noqa: E501
        if 'is_prohibit_login' in params:
            query_params.append(('is_prohibit_login', params['is_prohibit_login']))  # noqa: E501
    ...
    def delete_admin_runner(self, runner_id, **kwargs):  # noqa: E501
        """Delete a global runner  # noqa: E501
    ...
    def get_admin_runner_with_http_info(self, runner_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ActionRunner',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_admin_runners(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param bool disabled: filter by disabled status (true or false)
    ...
    def get_admin_runners_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ActionRunnersResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_admin_runner(self, runner_id, **kwargs):  # noqa: E501
        """Update a global runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_admin_runner(runner_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str runner_id: id of the runner (required)
        :param EditActionRunnerOption body:
        :return: ActionRunner
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_admin_runner_with_http_info(runner_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_admin_runner_with_http_info(runner_id, **kwargs)  # noqa: E501
            return data

    def update_admin_runner_with_http_info(self, runner_id, **kwargs):  # noqa: E501
        """Update a global runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_admin_runner_with_http_info(runner_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['runner_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_admin_runner" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'runner_id' is set
        if self.api_client.client_side_validation and ('runner_id' not in params or
                                                       params['runner_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `runner_id` when calling `update_admin_runner`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/admin/actions/runners/{runner_id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
