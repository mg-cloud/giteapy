...
class UserApi(object):
    ...
    def delete_user_runner(self, runner_id, **kwargs):  # noqa: E501
        """Delete a user-level runner  # noqa: E501
    ...
    def get_user_runner(self, runner_id, **kwargs):  # noqa: E501
        """Get a user-level runner  # noqa: E501
    ...
    def update_user_runner(self, runner_id, **kwargs):  # noqa: E501
        """Update a user-level runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user_runner(runner_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_user_runner_with_http_info(runner_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_user_runner_with_http_info(runner_id, **kwargs)  # noqa: E501
            return data

    def update_user_runner_with_http_info(self, runner_id, **kwargs):  # noqa: E501
        """Update a user-level runner  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_user_runner_with_http_info(runner_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_user_runner" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'runner_id' is set
        if self.api_client.client_side_validation and ('runner_id' not in params or
                                                       params['runner_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `runner_id` when calling `update_user_runner`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/user/actions/runners/{runner_id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
