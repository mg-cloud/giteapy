...
class EditHookOption(object):
    ...
    def __init__(self, active=None, authorization_header=None, branch_filter=None, config=None, events=None, name=None, _configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this EditHookOption.  # noqa: E501

        Optional human-readable name  # noqa: E501

        :return: The name of this EditHookOption.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this EditHookOption.

        Optional human-readable name  # noqa: E501

        :param name: The name of this EditHookOption.  # noqa: E501
        :type: str
        """
