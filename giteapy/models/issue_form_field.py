...
class IssueFormField(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["markdown", "textarea", "input", "dropdown", "checkboxes"]  # noqa: E501
    ...
    def visible(self, visible):
        ...
        :type: list[str]
        """
        allowed_values = ["form", "content"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(visible).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
                "Invalid values for `visible` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(visible) - set(allowed_values))),  # noqa: E501
