...
class MergePullRequestOption(object):
    ...
    def __init__(self, delete_branch_after_merge=None, do=None, force_merge=None, head_commit_id=None, merge_commit_id=None, merge_message_field=None, merge_title_field=None, merge_when_checks_succeed=None, _configuration=None):  # noqa: E501
