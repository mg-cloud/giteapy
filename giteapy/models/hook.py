...
class Hook(object):
    ...
    def __init__(self, active=None, authorization_header=None, branch_filter=None, config=None, created_at=None, events=None, id=None, name=None, type=None, updated_at=None, _configuration=None):  # noqa: E501
