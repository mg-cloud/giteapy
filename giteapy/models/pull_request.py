...
class PullRequest(object):
    ...
    def __init__(self, additions=None, allow_maintainer_edit=None, assignee=None, assignees=None, base=None, body=None, changed_files=None, closed_at=None, comments=None, content_version=None, created_at=None, deletions=None, diff_url=None, draft=None, due_date=None, head=None, html_url=None, id=None, is_locked=None, labels=None, merge_base=None, merge_commit_sha=None, mergeable=None, merged=None, merged_at=None, merged_by=None, milestone=None, number=None, patch_url=None, pin_order=None, requested_reviewers=None, requested_reviewers_teams=None, review_comments=None, state=None, title=None, updated_at=None, url=None, user=None, _configuration=None):  # noqa: E501
    ...
    def content_version(self):
        """Gets the content_version of this PullRequest.  # noqa: E501

        The version of the pull request content for optimistic locking  # noqa: E501

        :return: The content_version of this PullRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def content_version(self, content_version):
        """Sets the content_version of this PullRequest.

        The version of the pull request content for optimistic locking  # noqa: E501

        :param content_version: The content_version of this PullRequest.  # noqa: E501
        :type: int
        """
    ...
    def state(self):
        ...
        The current state of the pull request open StateOpen  StateOpen pr is opened closed StateClosed  StateClosed pr is closed  # noqa: E501
