...
class NotificationSubject(object):
    ...
    def state(self):
        ...
        State indicates the current state of the notification subject open NotifySubjectStateOpen  NotifySubjectStateOpen is an open subject closed NotifySubjectStateClosed  NotifySubjectStateClosed is a closed subject merged NotifySubjectStateMerged  NotifySubjectStateMerged is a merged pull request  # noqa: E501
    ...
    def type(self):
        ...
        Type indicates the type of the notification subject Issue NotifySubjectIssue  NotifySubjectIssue an issue is subject of an notification Pull NotifySubjectPull  NotifySubjectPull an pull is subject of an notification Commit NotifySubjectCommit  NotifySubjectCommit an commit is subject of an notification Repository NotifySubjectRepository  NotifySubjectRepository an repository is subject of an notification  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["Issue", "Pull", "Commit", "Repository"]  # noqa: E501
        if (self._configuration.client_side_validation and
