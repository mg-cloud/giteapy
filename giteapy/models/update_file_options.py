...
class UpdateFileOptions(object):
    ...
    def __init__(self, author=None, branch=None, committer=None, content=None, dates=None, force_push=None, from_path=None, message=None, new_branch=None, sha=None, signoff=None, _configuration=None):  # noqa: E501
    ...
    def branch(self):
        ...
        branch (optional) is the base branch for the changes. If not supplied, the default branch is used  # noqa: E501
    ...
    @property
    def force_push(self):
        """Gets the force_push of this UpdateFileOptions.  # noqa: E501

        force_push (optional) will do a force-push if the new branch already exists  # noqa: E501

        :return: The force_push of this UpdateFileOptions.  # noqa: E501
        :rtype: bool
        """
        return self._force_push

    @force_push.setter
    def force_push(self, force_push):
        """Sets the force_push of this UpdateFileOptions.

        force_push (optional) will do a force-push if the new branch already exists  # noqa: E501

        :param force_push: The force_push of this UpdateFileOptions.  # noqa: E501
        :type: bool
        """
    ...
    def message(self):
        ...
        message (optional) is the commit message of the changes. If not supplied, a default message will be used  # noqa: E501
    ...
    def new_branch(self):
        ...
        new_branch (optional) will make a new branch from base branch for the changes. If not supplied, the changes will be committed to the base branch  # noqa: E501
    ...
    def sha(self):
        ...
        the blob ID (SHA) for the file that already exists to update, or leave it empty to create a new file  # noqa: E501
