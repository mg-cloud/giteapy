...
class DeleteFileOptions(object):
    ...
    def __init__(self, author=None, branch=None, committer=None, dates=None, force_push=None, message=None, new_branch=None, sha=None, signoff=None, _configuration=None):  # noqa: E501
    ...
    @property
    def force_push(self):
        """Gets the force_push of this DeleteFileOptions.  # noqa: E501

        force_push (optional) will do a force-push if the new branch already exists  # noqa: E501

        :return: The force_push of this DeleteFileOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def force_push(self, force_push):
        """Sets the force_push of this DeleteFileOptions.

        force_push (optional) will do a force-push if the new branch already exists  # noqa: E501

        :param force_push: The force_push of this DeleteFileOptions.  # noqa: E501
        :type: bool
        """
    ...
    def sha(self):
        ...
        the blob ID (SHA) for the file to delete  # noqa: E501
